# Exercício 2.2 — QA: Spec de Testes SDD (Query Endpoint)
...
## Entregável 1 — test-plan.md (derivado dos Verification Criteria)
...
## Entregável 2 — Testes de Robustez da IA

```markdown
## Testes de Robustez — Query Endpoint
...
## Entregável 3 — Tabela Rastreável (formato Claude Cowork)
